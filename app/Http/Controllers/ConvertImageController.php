...
class ConvertImageController extends Controller
{
    public function index(Request $request)
    {
        ...
        $imgExt->writeImages(public_path('/file_djp_ttf_idm/Tesgambarbarcode3sendiri.jpeg'), true);
    ...
    public function readQr(){
        // phpinfo();
        $qrcode = new QrReader(public_path('/file_djp_ttf_idm/Tesgambarbarcode3sendiri.jpeg'));
        // print_r($qrcode);
        $text = $qrcode->text();
        // print_r("TES");
        print_r($text);
