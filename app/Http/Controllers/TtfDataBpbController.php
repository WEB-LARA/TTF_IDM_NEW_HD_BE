...
class TtfDataBpbController extends Controller
{
    public function getDataBPBPerSupplier(Request $request){
        ...
        $getData = $ttf_data_bpb->getDataBPBPerSupplier($request->supp_site_code,$request->branch_code,$id_bpb,$request->session_id,$request->flag_go,$request->flag_ppn,$request->tipe_faktur,$request->jenis_faktur);
