...
class TtfHeaderController extends Controller
{
    ...
    public function downloadLampiran(){
        ...
        {
            $zip->addFile("/usr/src/app/public/file_djp_ttf_idm/2023/Feb/002/230022473841/IVTBy80U2SpaliM1nJvSDdbTkuQTiJ6JD726LMsp.pdf","IVTBy80U2SpaliM1nJvSDdbTkuQTiJ6JD726LMsp.pdf");
        }
        $zip->close();
        // $filename = "test.zip";
